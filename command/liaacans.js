...
const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "status@broadcast"}, "message": {orderMessage: {itemCount: 2022,status: 200, jpegThumbnail: global.thumb, surface: 200, message: '©Created By Jul BOT', orderTitle: 'memek', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
...
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️BACK MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES BOT' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'OWNER' }, type: 1 }]
         ...
         break
case 'tesrow': case 'help': case 'command': {
let kafloc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `${global.fake}`,jpegThumbnail: global.thumb}}}
const sections = [
    {
	title: `ALL MENU`,
	...
	rows: [
	    {title: "ANONYMOUS MENU", rowId: `${prefix} anonymousmenu`}
	]
    },
    {
	title: `CONVERT MENU`,
...
let menunyaa = `Menampilkan List Menu Jul-Bot
...
const listMessage = {
  text: menunyaa,
  footer: "�Created by Julian Saputra",
  title: "━━━[ LIST Jul-BOT MENU ]━━━",
...
liaacans.sendMessage(m.chat, { react: { text: "🌹", key: m.key }})
    let anu = `*SAYA JULBOT, BOT WHATSAPP YANG MEMBANTU ANDA UNTUK MEMPERMUDAH SESUATU SEPERTI MEMBUAT STIKER DAN LAINNYA*.`
			...
			case 'confess':
				...
				header = 'hayyy'
				 ...
				 var button = [{ buttonId: `menfesconfirm`, buttonText: { displayText: `CONFIRM‡` }, type: 1 }, { buttonId: `sewabot`, buttonText: { displayText: `SEWABOT‡` }, type: 1 }]
					liaacans.sendMessage(`${nomor}@s.whatsapp.net`, { caption: teksnya, image: {url: `https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRMkjAJhYezm4h6k1AJ6qfreGkaRdBcR7UHMw&usqp=CAU`}, buttons: button, footer: `JulBOT` })
...
"optionName": "KATANYA KEBAL"
	...
	{
"optionName": "SALAM BROTHER BY Jul BOT"
	}
],
...
let noshp = text
if (isNaN(parseInt(noshp))) return m.reply(`${command} 628990772317`)
const sections = [
    {
...
case 'confirmorderkunci': { //KUNCI = BIAR GA DIAKSES HEHE
				...
				if (feta.status == false) {
  				...
  				liaacans.sendMessage(m.chat, {
    				caption: cap, image: {
      				url: feta.data.qris
    				}, buttons: buto, footer: `©Created Jul BOT`
  				})
				}
				console.log(feta)
				}
